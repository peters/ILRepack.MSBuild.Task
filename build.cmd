...
dotnet build -c Release deps/ilrepack/ilrepack/ilrepack.csproj
dotnet pack -c Release --no-build deps/ilrepack/ilrepack/ilrepack.csproj /p:ILRepackPackForRelease=true /p:Version=%version%
